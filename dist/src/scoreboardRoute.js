...
const scoreboard_get_1 = require("../services/scoreboard_get");
const router = express_1.default.Router();
router.get('/scoreboard', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const page = parseInt(req.query.page) || 1;
    const response = yield (0, scoreboard_get_1.scoreboardGET)(page);
